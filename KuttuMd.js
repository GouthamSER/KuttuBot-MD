...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    ...
    return await XeonBotInc.relayMessage(chatId, generate.message, { messageId: generate.key.id })
                ...
                XeonBotInc.sendMessage(m.chat, {
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: ownername,
                            previewType: "PHOTO",
                            thumbnail: fs.readFileSync('./Media/theme/botpic.jpg'),
                            sourceUrl: wagc
                        }
                    },
                    text: teks
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./Media/theme/botpic.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
	    const frpayment = {
	key: {
...
fs.writeFileSync('./src/data/role/user.json', JSON.stringify(xeonverifieduser, null, 2))
        ...
        switch (isCommand) {
            ...
            case 'sim': {
                ...
                await fsx.copy(delb, './Media/theme/botpic.jpg')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
            ...
            case 'sgm': {
                if (!XeonTheCreator) return XeonStickOwner()
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                await fsx.copy(delb, './Media/theme/botvideo.mp4')
                fs.unlinkSync(delb)
                replygcxeon(mess.done)
            }
            break
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://ibb.co/tKb3qrH',
                                sourceUrl: wagc,
                                mediaType: 1,
                                renderLargerThumbnail: true
                            }
...
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./Media/theme/botpic.jpg'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./Media/theme/botvideo.mp4'),
                        caption: xmenu_oh
                    }, {
                        quoted: m
                    })
